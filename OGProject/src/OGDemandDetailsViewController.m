...
- (void)viewDidLoad {
    ...
    //赋值
    [demandDetailsView DemandDetailsViewSetTitle:@"想要找个软装设计方案"
                                            Time:@"2013-01-14 17:12"
                                     DesignerNum:@"8"
                                     DesignerPic:array];
    
    
    [demandDetailsView DemandDetailsViewSetArea:@"238M"
                                      HouseType:@"三室二厅"
                                          Style:@"现代 欧美"
                                        Address:@"长沙开福区北辰三角洲"
                                         Budget:@"20-30万"
                                   HouseTypeImg:@"8-户型图.png"
                                    DetailedMsg:@"希望是简约风格,适合年轻人居住"];
}
