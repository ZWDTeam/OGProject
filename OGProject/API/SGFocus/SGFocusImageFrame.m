...
- (void)setupViews
{
    ...
    titleLable.backgroundColor =[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.3];
...
//        imageView.backgroundColor = i%2?[UIColor redColor]:[UIColor blueColor];
        if (item.image) {
            ...
            imageView.image =[UIImage imageNamed:@"downloading_180pt"];
//            [BCNetWorkingRequest downLoadImage:item.imageUrl qualityRatio:1.0 pixelRatio:1.0
//                                responseObject:^(id responseObject) {
//            imageView.image =responseObject;
//        }
//                                       failure:^(NSError *error ,NSString * pathString) {
//            imageView.image =[UIImage imageNamed:@"updataError_180pt"];
//        }];
